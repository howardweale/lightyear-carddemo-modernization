-- Synthetic bounded catalog case ORA-TYPE-014-CASE-01; AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-014-CASE-01', 'observations', json_build_object('comparison', v_comparison, 'session_value', v_session_value));
END $pilot$;
ROLLBACK;
