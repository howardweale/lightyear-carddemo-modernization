...
$CloudBankFragment = Join-Path $ProjectDir "reference-estates\cloudbank\cloudbank-reference.fragment.json"
...
Write-Error "Usage: .\composite-estate.ps1 [build|verify] [optional-carddemo-upstream-root]"
exit 2
