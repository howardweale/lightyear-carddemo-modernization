...
class CloudBankPlatformQualificationTests(unittest.TestCase):
    ...
    def test_ledger_and_launchers_keep_ms68_open(self) -> None:
        ...
        for relative in (
            ...
            "factory/cloudbank/platform-qualification/gke/cloudbuild-ms66-dual-lane.yaml",
            "factory/cloudbank/platform-qualification/gke/cloudbuild-ms66-recovery.yaml",
            ...
            "factory/cloudbank/platform-qualification/gke/submit-ms66-dual-lane.sh",
            "factory/cloudbank/platform-qualification/gke/submit-ms66-recovery.sh",
