-- Synthetic catalog case ORA-TYPE-043-CASE-01; target AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-043-CASE-01', 'observations', json_build_object('boundary', v_boundary, 'time_value', v_time_value));
END $pilot$;
ROLLBACK;
