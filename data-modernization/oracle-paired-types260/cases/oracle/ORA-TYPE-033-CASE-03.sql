-- Synthetic bounded catalog case ORA-TYPE-033-CASE-03; Oracle 26ai.
DECLARE
...
BEGIN
 ...
 SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-033-CASE-03', 'observations' VALUE
 JSON_OBJECT('boundary' VALUE v_boundary, 'comparison' VALUE v_comparison, 'session_value' VALUE v_session_value NULL ON NULL) RETURNING VARCHAR2(4000)) INTO v_json FROM dual;
