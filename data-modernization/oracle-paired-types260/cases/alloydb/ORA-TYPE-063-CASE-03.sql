-- Synthetic bounded catalog case ORA-TYPE-063-CASE-03; AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-063-CASE-03', 'observations', json_build_object('boundary', v_boundary, 'comparison', v_comparison, 'session_value', v_session_value));
END $pilot$;
ROLLBACK;
