-- Synthetic catalog case ORA-TYPE-039-CASE-04; target AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-039-CASE-04', 'observations', json_build_object('format_a', v_format_a, 'format_b', v_format_b, 'overflow_code', v_overflow_code, 'recovery', v_recovery));
END $pilot$;
ROLLBACK;
