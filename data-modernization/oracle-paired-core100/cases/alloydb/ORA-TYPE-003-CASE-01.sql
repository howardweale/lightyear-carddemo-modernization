...
BEGIN
 ...
 RAISE NOTICE 'LY_PAIRED_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-003-CASE-01', 'observations', json_build_object('maximum', v_maximum, 'overflow_code', v_overflow, 'rounded', v_rounded));
END $pilot$;
ROLLBACK;
