-- Synthetic catalog case ORA-TYPE-040-CASE-04; target AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-040-CASE-04', 'observations', json_build_object('overflow_code', v_overflow_code, 'recovery', v_recovery));
END $pilot$;
ROLLBACK;
