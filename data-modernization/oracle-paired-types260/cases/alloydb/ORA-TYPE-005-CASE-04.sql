...
BEGIN
 ...
 RAISE NOTICE 'LY_PAIRED_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-005-CASE-04', 'observations', json_build_object('overflow_code', v_overflow, 'recovery', v_recovery));
END $pilot$;
ROLLBACK;
