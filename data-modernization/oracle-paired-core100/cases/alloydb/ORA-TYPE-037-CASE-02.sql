-- Synthetic catalog case ORA-TYPE-037-CASE-02; target AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-037-CASE-02', 'observations', json_build_object('null_value', v_null_value));
END $pilot$;
ROLLBACK;
