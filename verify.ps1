...
& (Join-Path $ProjectDir "cloudbank-transaction-core.ps1") verify
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

& (Join-Path $ProjectDir "cloudbank-native-wave.ps1") verify
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

& (Join-Path $ProjectDir "cloudbank-oracle-equivalence.ps1") verify
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

& (Join-Path $ProjectDir "cloudbank-production-oauth.ps1") verify
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
& (Join-Path $ProjectDir "cloudbank-checks-messaging.ps1") verify
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
& (Join-Path $ProjectDir "cloudbank-edge-ai.ps1") verify
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
& (Join-Path $ProjectDir "cloudbank-production-readiness.ps1") verify
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
...
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
& (Join-Path $ProjectDir "idempiere-divergence-audit.ps1") verify-comparison
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
& (Join-Path $ProjectDir "idempiere-divergence-audit.ps1") verify-triage
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
