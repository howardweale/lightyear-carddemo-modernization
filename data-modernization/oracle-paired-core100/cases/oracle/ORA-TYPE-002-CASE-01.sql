-- Catalog case ORA-TYPE-002-CASE-01; lane 26ai; null and absence semantics; canonical
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'ALTER SESSION SET NLS_NUMERIC_CHARACTERS = ''.,''';
  SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-002-CASE-01', 'observations' VALUE
