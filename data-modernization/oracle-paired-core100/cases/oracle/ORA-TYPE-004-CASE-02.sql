-- Catalog case ORA-TYPE-004-CASE-02; lane 26ai; session, ordering, and version semantics; null-boundary
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'ALTER SESSION SET NLS_NUMERIC_CHARACTERS = ''.,''';
  SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-004-CASE-02', 'observations' VALUE
    JSON_OBJECT('nls_comma' VALUE v_comma,
      'nls_dot' VALUE v_dot,
      'null_value' VALUE v_null NULL ON NULL) RETURNING VARCHAR2(4000)) INTO v_json FROM dual;
