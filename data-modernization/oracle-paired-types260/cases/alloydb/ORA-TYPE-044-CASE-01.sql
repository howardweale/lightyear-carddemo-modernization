-- Synthetic catalog case ORA-TYPE-044-CASE-01; target AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-044-CASE-01', 'observations', json_build_object('format_a', v_format_a, 'format_b', v_format_b));
END $pilot$;
ROLLBACK;
