-- Catalog case ORA-TYPE-005-CASE-04; lane 26ai; failure and diagnostic semantics; failure-recovery
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'ALTER SESSION SET NLS_NUMERIC_CHARACTERS = ''.,''';
  SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-005-CASE-04', 'observations' VALUE
