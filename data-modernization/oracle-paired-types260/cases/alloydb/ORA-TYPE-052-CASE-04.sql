-- Synthetic bounded catalog case ORA-TYPE-052-CASE-04; AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-052-CASE-04', 'observations', json_build_object('null_value', v_null_value, 'overflow_code', v_overflow_code, 'recovery', v_recovery));
END $pilot$;
ROLLBACK;
