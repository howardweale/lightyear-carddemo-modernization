-- Catalog case ORA-TYPE-003-CASE-02; lane 26ai; boundary and overflow semantics; null-boundary
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'ALTER SESSION SET NLS_NUMERIC_CHARACTERS = ''.,''';
  SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-003-CASE-02', 'observations' VALUE
    JSON_OBJECT('maximum' VALUE v_maximum,
      'null_value' VALUE v_null,
