-- Synthetic bounded catalog case ORA-TYPE-035-CASE-01; Oracle 26ai.
DECLARE
...
BEGIN
 ...
 SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-035-CASE-01', 'observations' VALUE
 JSON_OBJECT('overflow_code' VALUE v_overflow_code, 'recovery' VALUE v_recovery NULL ON NULL) RETURNING VARCHAR2(4000)) INTO v_json FROM dual;
