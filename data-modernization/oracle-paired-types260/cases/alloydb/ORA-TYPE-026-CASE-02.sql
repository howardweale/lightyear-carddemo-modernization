-- Synthetic bounded catalog case ORA-TYPE-026-CASE-02; AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 CREATE TEMP TABLE LY_ORA_TYPE_026_CASE_02 (v char(3)) ON COMMIT DROP;
 INSERT INTO pg_temp.LY_ORA_TYPE_026_CASE_02 VALUES (U&'\03A9\03A9\03A9');
 SELECT v INTO v_boundary FROM pg_temp.LY_ORA_TYPE_026_CASE_02;
 BEGIN
   INSERT INTO pg_temp.LY_ORA_TYPE_026_CASE_02 VALUES (U&'\03A9\03A9\03A9\03A9');
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-026-CASE-02', 'observations', json_build_object('canonical', v_canonical, 'null_value', v_null_value));
END $pilot$;
ROLLBACK;
