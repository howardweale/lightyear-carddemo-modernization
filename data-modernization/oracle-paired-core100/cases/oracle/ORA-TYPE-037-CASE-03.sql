-- Synthetic catalog case ORA-TYPE-037-CASE-03; source Oracle 26ai.
DECLARE
...
BEGIN
  ...
  SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-037-CASE-03', 'observations' VALUE
    JSON_OBJECT('format_a' VALUE v_format_a, 'format_b' VALUE v_format_b, 'null_value' VALUE v_null_value NULL ON NULL) RETURNING VARCHAR2(4000)) INTO v_json FROM dual;
