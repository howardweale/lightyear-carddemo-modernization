...
BEGIN
 ...
 RAISE NOTICE 'LY_PAIRED_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-001-CASE-03', 'observations', json_build_object('arithmetic', v_sum, 'nls_comma', v_comma, 'nls_dot', v_dot));
END $pilot$;
ROLLBACK;
