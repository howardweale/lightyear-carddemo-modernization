...
BEGIN
 ...
 RAISE NOTICE 'LY_PAIRED_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-003-CASE-02', 'observations', json_build_object('maximum', v_maximum, 'null_value', v_null, 'overflow_code', v_overflow, 'rounded', v_rounded));
END $pilot$;
ROLLBACK;
