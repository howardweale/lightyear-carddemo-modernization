...
BEGIN
 ...
 RAISE NOTICE 'LY_PAIRED_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-004-CASE-04', 'observations', json_build_object('nls_comma', v_comma, 'nls_dot', v_dot, 'overflow_code', v_overflow, 'recovery', v_recovery));
END $pilot$;
ROLLBACK;
