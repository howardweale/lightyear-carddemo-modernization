...
if [[ "$action" == "build" ]]; then
  ...
  generated_json="$verification_dir/carddemo-intcalc-v0.12-demo.json"
  generated_markdown="$verification_dir/carddemo-intcalc-v0.12-demo.md"
  ...
  "$LIGHTYEAR_PYTHON_BIN" -m lightyear_audit compare \
    ...
    --actual "$generated"
  cmp "$project_dir/audit/dossiers/carddemo-intcalc-v0.12-demo.json" "$generated_json"
  cmp "$project_dir/audit/dossiers/carddemo-intcalc-v0.12-demo.md" "$generated_markdown"
