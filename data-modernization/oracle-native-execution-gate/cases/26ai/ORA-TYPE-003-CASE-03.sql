-- Catalog case ORA-TYPE-003-CASE-03; lane 26ai; boundary and overflow semantics; session-version
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'ALTER SESSION SET NLS_NUMERIC_CHARACTERS = ''.,''';
  SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-003-CASE-03', 'observations' VALUE
    JSON_OBJECT('maximum' VALUE v_maximum,
      'nls_comma' VALUE v_comma,
      'nls_dot' VALUE v_dot,
