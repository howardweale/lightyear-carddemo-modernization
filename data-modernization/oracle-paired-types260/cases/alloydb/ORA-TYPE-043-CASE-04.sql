-- Synthetic catalog case ORA-TYPE-043-CASE-04; target AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-043-CASE-04', 'observations', json_build_object('boundary', v_boundary, 'overflow_code', v_overflow_code, 'recovery', v_recovery, 'time_value', v_time_value));
END $pilot$;
ROLLBACK;
