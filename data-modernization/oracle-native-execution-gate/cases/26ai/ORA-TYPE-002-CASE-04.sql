-- Catalog case ORA-TYPE-002-CASE-04; lane 26ai; null and absence semantics; failure-recovery
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'ALTER SESSION SET NLS_NUMERIC_CHARACTERS = ''.,''';
  SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-002-CASE-04', 'observations' VALUE
