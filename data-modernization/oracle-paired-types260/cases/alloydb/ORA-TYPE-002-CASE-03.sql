...
BEGIN
 ...
 RAISE NOTICE 'LY_PAIRED_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-002-CASE-03', 'observations', json_build_object('nls_comma', v_comma, 'nls_dot', v_dot, 'null_value', v_null));
END $pilot$;
ROLLBACK;
