...
class MilestoneDocumentationTests(unittest.TestCase):
    ...
    def test_manifest_is_complete_and_content_addressed(self) -> None:
        ...
        self.assertEqual([a["path"] for a in supplemental], ["docs/milestones/MS-73/MS-73.md", "docs/milestones/MS-74/MS-74.md", "docs/milestones/MS-75/MS-75.md", "docs/milestones/MS-76/MS-76.md", "docs/milestones/MS-77/MS-77.md", "docs/milestones/MS-78/MS-78.md", "docs/milestones/MS-79/MS-79.md", "docs/milestones/MS-80/MS-80.md", "docs/milestones/MS-81/MS-81.md", "docs/milestones/MS-82/MS-82.md", "docs/milestones/MS-83/MS-83.md", "docs/milestones/MS-84/MS-84.md"])
        ...
        self.assertEqual(manifest["supplemental_milestone_count"], 12)
        self.assertEqual(manifest["searchable_milestone_count"], 82)
...
search.value='PR #214'; search.apply(); result.pr214=visible();
search.value='PR #215'; search.apply(); result.pr215=visible();
...
console.log(JSON.stringify(result));'''
        ...
        self.assertEqual(12, len(output["later"]))
