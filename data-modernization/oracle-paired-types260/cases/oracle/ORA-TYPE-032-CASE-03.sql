-- Synthetic bounded catalog case ORA-TYPE-032-CASE-03; Oracle 26ai.
DECLARE
...
BEGIN
 ...
 SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-032-CASE-03', 'observations' VALUE
