-- Synthetic bounded catalog case ORA-TYPE-026-CASE-04; AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 CREATE TEMP TABLE LY_ORA_TYPE_026_CASE_04 (v char(3)) ON COMMIT DROP;
 INSERT INTO pg_temp.LY_ORA_TYPE_026_CASE_04 VALUES (U&'\03A9\03A9\03A9');
 SELECT v INTO v_boundary FROM pg_temp.LY_ORA_TYPE_026_CASE_04;
 BEGIN
   INSERT INTO pg_temp.LY_ORA_TYPE_026_CASE_04 VALUES (U&'\03A9\03A9\03A9\03A9');
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-026-CASE-04', 'observations', json_build_object('canonical', v_canonical, 'overflow_code', v_overflow_code, 'recovery', v_recovery));
END $pilot$;
ROLLBACK;
