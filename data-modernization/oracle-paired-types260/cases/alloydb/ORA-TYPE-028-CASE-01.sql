-- Synthetic bounded catalog case ORA-TYPE-028-CASE-01; AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 CREATE TEMP TABLE LY_ORA_TYPE_028_CASE_01 (v char(3)) ON COMMIT DROP;
 INSERT INTO pg_temp.LY_ORA_TYPE_028_CASE_01 VALUES (U&'\03A9\03A9\03A9');
 SELECT v INTO v_boundary FROM pg_temp.LY_ORA_TYPE_028_CASE_01;
 BEGIN
   INSERT INTO pg_temp.LY_ORA_TYPE_028_CASE_01 VALUES (U&'\03A9\03A9\03A9\03A9');
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-028-CASE-01', 'observations', json_build_object('boundary', v_boundary));
END $pilot$;
ROLLBACK;
