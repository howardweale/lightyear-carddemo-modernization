-- Synthetic catalog case ORA-TYPE-038-CASE-01; source Oracle 26ai.
DECLARE
...
BEGIN
  ...
  SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-038-CASE-01', 'observations' VALUE
    JSON_OBJECT('boundary' VALUE v_boundary, 'time_value' VALUE v_time_value NULL ON NULL) RETURNING VARCHAR2(4000)) INTO v_json FROM dual;
