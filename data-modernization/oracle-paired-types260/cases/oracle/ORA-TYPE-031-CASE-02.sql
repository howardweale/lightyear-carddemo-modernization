-- Synthetic bounded catalog case ORA-TYPE-031-CASE-02; Oracle 26ai.
DECLARE
...
BEGIN
 ...
 SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-031-CASE-02', 'observations' VALUE
 JSON_OBJECT('canonical' VALUE v_canonical, 'null_value' VALUE v_null_value NULL ON NULL) RETURNING VARCHAR2(4000)) INTO v_json FROM dual;
