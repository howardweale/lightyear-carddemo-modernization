...
OPERATOR_WORKLOADS = [
    ...
    },
    {
        ...
        "recommended_scope": "database",
        "description": "Customer is qualified, all eight services are planned, and the Account/Transfer PostgreSQL target is generated and ready for an operator-held MS #59 native run.",
        "target_dialect": "postgresql-16",
        "target_status": "customer qualified · transaction target ready",
        "mapping_artifact": "reference-estates/cloudbank/customer-postgresql/mapping.json",
        "factory_artifact": "factory/cloudbank/transaction-core/readiness.receipt.json",
    },
    {
        ...
        "recommended_scope": "database",
        "description": "MS #59 generates a PostgreSQL atomic transfer command with idempotency, authorization, ordered locks, paired journals, rollback, and retry; native operator evidence is still pending.",
        "target_dialect": "postgresql-16",
        "target_status": "transaction target generated · native run pending",
        "factory_artifact": "factory/cloudbank/transaction-core/readiness.receipt.json",
    },
    {
