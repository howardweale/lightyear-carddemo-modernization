...
BEGIN
 ...
 RAISE NOTICE 'LY_PAIRED_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-003-CASE-03', 'observations', json_build_object('maximum', v_maximum, 'nls_comma', v_comma, 'nls_dot', v_dot, 'overflow_code', v_overflow, 'rounded', v_rounded));
END $pilot$;
ROLLBACK;
