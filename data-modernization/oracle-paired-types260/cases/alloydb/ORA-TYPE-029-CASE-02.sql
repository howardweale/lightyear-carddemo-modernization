-- Synthetic bounded catalog case ORA-TYPE-029-CASE-02; AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 CREATE TEMP TABLE LY_ORA_TYPE_029_CASE_02 (v char(3)) ON COMMIT DROP;
 INSERT INTO pg_temp.LY_ORA_TYPE_029_CASE_02 VALUES (U&'\03A9\03A9\03A9');
 SELECT v INTO v_boundary FROM pg_temp.LY_ORA_TYPE_029_CASE_02;
 BEGIN
   INSERT INTO pg_temp.LY_ORA_TYPE_029_CASE_02 VALUES (U&'\03A9\03A9\03A9\03A9');
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-029-CASE-02', 'observations', json_build_object('comparison', v_comparison, 'null_value', v_null_value, 'session_value', v_session_value));
END $pilot$;
ROLLBACK;
