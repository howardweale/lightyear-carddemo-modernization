-- Catalog case ORA-TYPE-001-CASE-01; lane 26ai; canonical semantics; canonical
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'ALTER SESSION SET NLS_NUMERIC_CHARACTERS = ''.,''';
  SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-001-CASE-01', 'observations' VALUE
    JSON_OBJECT('arithmetic' VALUE v_sum NULL ON NULL) RETURNING VARCHAR2(4000)) INTO v_json FROM dual;
