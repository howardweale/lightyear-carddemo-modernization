-- Synthetic bounded catalog case ORA-TYPE-048-CASE-02; AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-048-CASE-02', 'observations', json_build_object('boundary', v_boundary, 'null_value', v_null_value));
END $pilot$;
ROLLBACK;
