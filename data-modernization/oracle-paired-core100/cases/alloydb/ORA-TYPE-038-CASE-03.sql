-- Synthetic catalog case ORA-TYPE-038-CASE-03; target AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-038-CASE-03', 'observations', json_build_object('boundary', v_boundary, 'format_a', v_format_a, 'format_b', v_format_b, 'time_value', v_time_value));
END $pilot$;
ROLLBACK;
