...
case "$action" in
  ...
  sign)
    ...
    ;;
  *) echo "Usage: ./data-modernization.sh [build|verify|semantic-core|oracle-postgresql-proof|stored-logic|live-postgres|live-oracle|live-all|sign] [optional-carddemo-upstream-root]" >&2; exit 2 ;;
esac
