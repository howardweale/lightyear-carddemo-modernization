...
DEFAULT_DOSSIER_JSON = Path("audit/dossiers/carddemo-intcalc-v0.13-demo.json")
DEFAULT_DOSSIER_MD = Path("audit/dossiers/carddemo-intcalc-v0.13-demo.md")
DEFAULT_RELEASE = "release:carddemo-intcalc:v0.13-demo"
