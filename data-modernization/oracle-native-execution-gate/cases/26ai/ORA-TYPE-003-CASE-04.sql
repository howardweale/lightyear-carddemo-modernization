-- Catalog case ORA-TYPE-003-CASE-04; lane 26ai; boundary and overflow semantics; failure-recovery
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'ALTER SESSION SET NLS_NUMERIC_CHARACTERS = ''.,''';
  SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-003-CASE-04', 'observations' VALUE
    JSON_OBJECT('maximum' VALUE v_maximum,
      'overflow_code' VALUE v_overflow,
      'recovery' VALUE v_recovery,
      'rounded' VALUE v_rounded NULL ON NULL) RETURNING VARCHAR2(4000)) INTO v_json FROM dual;
