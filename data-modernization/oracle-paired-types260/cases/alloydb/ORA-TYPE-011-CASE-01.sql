-- Synthetic bounded catalog case ORA-TYPE-011-CASE-01; AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-011-CASE-01', 'observations', json_build_object('canonical', v_canonical));
END $pilot$;
ROLLBACK;
