...
OPERATOR_WORKLOADS = [
    ...
    },
    {
        ...
        "recommended_scope": "database",
        "description": "MS #61 compares original Oracle Account behavior and Transfer orchestration with the generated PostgreSQL target under one seven-scenario normalized contract.",
        "target_dialect": "postgresql-16",
        "target_status": "bounded Oracle/PostgreSQL equivalence ready · operator receipt required",
        "factory_artifact": "factory/cloudbank/oracle-equivalence/readiness.receipt.json",
    },
    {
