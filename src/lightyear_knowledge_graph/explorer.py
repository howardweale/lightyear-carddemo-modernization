...
OPERATOR_WORKLOADS = [
    ...
    },
    {
        ...
        "recommended_scope": "database",
        "description": "Customer is qualified, all eight services are planned, and MS #60 adds the isolated Account/Transfer native PostgreSQL HTTP wave with restart and concurrency gates.",
        "target_dialect": "postgresql-16",
        "target_status": "customer qualified · integrated wave ready",
        "mapping_artifact": "reference-estates/cloudbank/customer-postgresql/mapping.json",
        "factory_artifact": "factory/cloudbank/native-transaction-wave/readiness.receipt.json",
    },
    {
        ...
        "recommended_scope": "database",
        "description": "MS #60 starts Account and Transfer together for authenticated HTTP, durable replay across both service restarts, concurrency, conservation, and package inspection; the signed native run remains operator-held evidence.",
        "target_dialect": "postgresql-16",
        "target_status": "integrated native wave ready · operator receipt required",
        "factory_artifact": "factory/cloudbank/native-transaction-wave/readiness.receipt.json",
    },
    {
