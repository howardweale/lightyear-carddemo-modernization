...
- `dossiers/carddemo-intcalc-v0.19-demo.json`: current machine-readable release evidence dossier;
- `dossiers/carddemo-intcalc-v0.19-demo.md`: current human-readable dossier;
...
PYTHONPATH=src python3 -m lightyear_audit inspect \
  --decision decision:release:carddemo-intcalc:v0.19-demo:promotion
```
