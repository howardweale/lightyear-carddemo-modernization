-- Synthetic bounded catalog case ORA-TYPE-033-CASE-04; Oracle 26ai.
DECLARE
...
BEGIN
 ...
 SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-033-CASE-04', 'observations' VALUE
 JSON_OBJECT('boundary' VALUE v_boundary, 'overflow_code' VALUE v_overflow_code, 'recovery' VALUE v_recovery NULL ON NULL) RETURNING VARCHAR2(4000)) INTO v_json FROM dual;
