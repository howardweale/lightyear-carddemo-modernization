-- Catalog case ORA-TYPE-005-CASE-02; lane 26ai; failure and diagnostic semantics; null-boundary
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'ALTER SESSION SET NLS_NUMERIC_CHARACTERS = ''.,''';
  SELECT JSON_OBJECT('case_id' VALUE 'ORA-TYPE-005-CASE-02', 'observations' VALUE
    JSON_OBJECT('null_value' VALUE v_null,
