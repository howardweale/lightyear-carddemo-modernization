-- Synthetic bounded catalog case ORA-TYPE-014-CASE-02; AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-014-CASE-02', 'observations', json_build_object('comparison', v_comparison, 'null_value', v_null_value, 'session_value', v_session_value));
END $pilot$;
ROLLBACK;
