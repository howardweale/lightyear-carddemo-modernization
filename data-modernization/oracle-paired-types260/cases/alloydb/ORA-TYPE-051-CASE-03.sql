-- Synthetic bounded catalog case ORA-TYPE-051-CASE-03; AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-051-CASE-03', 'observations', json_build_object('canonical', v_canonical, 'comparison', v_comparison, 'session_value', v_session_value));
END $pilot$;
ROLLBACK;
