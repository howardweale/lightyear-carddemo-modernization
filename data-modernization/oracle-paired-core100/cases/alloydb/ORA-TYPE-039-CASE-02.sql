-- Synthetic catalog case ORA-TYPE-039-CASE-02; target AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-039-CASE-02', 'observations', json_build_object('format_a', v_format_a, 'format_b', v_format_b, 'null_value', v_null_value));
END $pilot$;
ROLLBACK;
