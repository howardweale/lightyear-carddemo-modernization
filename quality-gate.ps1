...
if ($Action -eq "sign") {
    ...
    Invoke-FactoryDarkPython -m lightyear_factory sign-eval-catalog --catalog $Arguments[0] `
    ...
    Invoke-FactoryDarkPython -m lightyear_factory validate-sealed-eval --envelope $Arguments[0]
    ...
    Invoke-FactoryDarkPython -m lightyear_factory evaluate --project-root $ProjectDir `
    ...
    Invoke-FactoryDarkPython -m lightyear_factory compare-evals @ReceiptArgs
}
exit $LASTEXITCODE
