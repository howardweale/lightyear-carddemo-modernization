-- Synthetic bounded catalog case ORA-TYPE-055-CASE-03; AlloyDB PostgreSQL.
BEGIN;
...
BEGIN
 ...
 RAISE NOTICE 'LY_TYPES_OBSERVATION=%', json_build_object('case_id', 'ORA-TYPE-055-CASE-03', 'observations', json_build_object('comparison', v_comparison, 'overflow_code', v_overflow_code, 'recovery', v_recovery, 'session_value', v_session_value));
END $pilot$;
ROLLBACK;
